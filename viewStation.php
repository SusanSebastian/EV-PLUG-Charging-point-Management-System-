    ...
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        ...
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item"><a href="#" class="nav-link">View Station</a></li>
...
<!-- ########## START: MAIN PANEL ########## -->
  ...
  <div>
        <div>
            <div class="table-title" style="margin-top:100px; margin-left: 300px;">
                <div class="row">
                    <div class="col-sm-8"><h2><b>Station Details</b></h2></div>
                    <div class="col-sm-4">
                        <a href="addStation.php" ><i class="fa fa-plus"></i> Add New</a>
                    </div>
                </div>
            </div>
                ...
                <tbody>
                  <?php  
                    ...
                    while($row = mysqli_fetch_array($result)){ 
                      $sid = $row['stationId'];
                    //display manager assigned to a station
                      $managerAssignQuery = "SELECT managerName FROM tbl_manager where stationId='$sid'";
                      $managerAssignQueryResult = mysqli_query($db,$managerAssignQuery);
                      $managerAssignRow = mysqli_fetch_assoc($managerAssignQueryResult);

                      if($managerAssignRow!=null){
                        $mname = $managerAssignRow['managerName'];
                      }
                      ...
                      //display services assigned to a station
                      $serviceQuery = "SELECT * FROM tbl_mapping where stationId='$sid'";
                    ...
                    <tr>
                        ...
                        <td>
                            <button style="width:80px" class="btn btn-primary">
                              <a style="color:white" href="updateStation.php?id=<?php echo $row["stationId"]; ?>">Edit</button>
                            <button style="width:80px" class="btn btn-danger">
                              <a style="color:white" href="deleteStation.php?id=<?php echo $row["stationId"]; ?>" onclick="return checkDelete()">Delete</a></button>
                        </td>
                   </tr>  
                  <?php } ?>
                  <!-- <?php //} ?>    -->
