...
<!-- ########## START: MAIN PANEL ########## -->
    <div id="viewmanager" style="margin-left:50px">
  <!-- Manager Management -->
  <?php
    $db = mysqli_connect("localhost","root","","db_evplug");
    $query = "SELECT * from tbl_vehiclemodel where status=0";
        ...
        <div class="table-wrapper">
            <div class="table-title" style="margin-top:100px; margin-left: 300px;">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <a href="addVehicle.php" ><i class="fa fa-plus"></i> Add New</a>
                    </div>
                </div>
            </div>
            <table class="table table-bordered" style="width:1000px;">
                ...
                <tbody>
                  <?php while($row=mysqli_fetch_array($result)){ 
                    ...
                    <tr>
                      <?php 
                          $brandquery = mysqli_query($db,"SELECT * FROM tbl_vehiclebrand where status = 0");
                      ...
                      ?>
                        ...
                        <td>
                            <button style="width:80px" class="btn btn-primary"><a style="color:white" href="updateBrand.php?id=<?php echo $row['brandId']; ?>">Edit</button>
                            <button style="width:80px" class="btn btn-danger">
                              <a style="color:white" href="deleteBrand.php?id=<?php echo $row['brandId']; ?>" onclick="return checkDelete()">Delete</a></button>
                        </td>
                   </tr>  
                   <?php } ?>   
                </tbody>
