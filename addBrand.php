...
<form method="POST" onsubmit="return chargeValid()" name="addStation">
    <center>
       <h1 style="margin-top: 10%; margin-left: 175px">New Brand</h1>
       <br>
    <table>
        <tr>
        ...
        <tr>
            ...
            <td>
              <div>
                    <input type="text" style="margin-left: 20px;" placeholder="Enter Brand Name" name="brandName" id="brandName">
                </div>
            </td>
        </tr>
      </table>
...
//   // receive all input values from the form
  ...
  $query2 = "SELECT brandName from tbl_vehiclebrand where brandName='$brand' and type='$type'";
  $result2 = mysqli_query($db,$query2);
  $vehicle2 = mysqli_fetch_assoc($result2);

  if ($vehicle2){ // if user exists
    if ($vehicle2['brandName'] == $brand) {
      array_push($errors, "Vehicle Brand already exists");
    }
  }
  if (count($errors) == 0) {
    $ins_query = "INSERT INTO tbl_vehiclebrand(brandName,type,status)VALUES('$brand','$type',0)";
