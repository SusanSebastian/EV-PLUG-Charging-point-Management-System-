...
<html lang="en">
    ...
    <body>
        ...
        <div id="Bookingdetails">
            <center>
            <div style="width: 70%;" class="w3-container">
                  ...
                  <table>
                        <tr>
                         ...
                         <tr>
                            ...
                            ?>
                            <td class="second-row"><?php echo $type ?></td>
                        </tr>
                        <tr>
                            <td>Charging  Slot</td>
                    ...
                    <input type="submit" value="Proceed to Booking" name="continue" id="continue" style="width: 40%">
                </div>
              </div>
              </form>
            </div>
...
if(isset($_POST['continue'])){
    ...
    if($bookingQuery){
        $timeslotstatusquery = mysqli_query($db, "update tbl_timeslot set status=1 where stationId='$sid' and slot='$time'");
