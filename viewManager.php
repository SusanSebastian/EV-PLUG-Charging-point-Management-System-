  ...
  <body>
    ...
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        ...
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item"><a href="#" class="nav-link">View Manager</a></li>
...
<!-- ########## START: MAIN PANEL ########## -->
  ...
  <?php
    ...
    $query = "SELECT * from tbl_manager where status=1";
        ...
        <div class="table-wrapper">
            <div class="table-title" style="margin-top:100px; margin-left: 300px;">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <a href="addManager.php" ><i class="fa fa-plus"></i> Add New</a>
                    </div>
                </div>
            </div>
            <table class="table table-bordered" style="width:1000px">
                ...
                <tbody>
                  <?php while($row=mysqli_fetch_array($result)){ 
                    $sid = $row['stationId'];
                    $loginId=$row['loginId'];
                    $selectStation = mysqli_query($db, "SELECT stationName from tbl_station where stationId=$sid and status=1");
                    $selectEmail=mysqli_query($db,"SELECT email from tbl_login where loginId='$loginId'");
                    while($stationRow = mysqli_fetch_array($selectStation)) {
                      while($row2 = mysqli_fetch_array($selectEmail)){
                    ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <button style="width:80px" class="btn btn-primary"><a style="color:white" href="updateManager.php?id=<?php echo $row['managerId']; ?>">Edit</button>
                            <button style="width:80px" class="btn btn-danger">
                              <a style="color:white" href="deleteManager.php?id=<?php echo $row['managerId']; ?>&email=<?php echo $row2['email']; ?>" onclick="return checkDelete()">Delete</a></button>
                        </td>
                   </tr>  
                   <?php }}} ?>   
                </tbody>
