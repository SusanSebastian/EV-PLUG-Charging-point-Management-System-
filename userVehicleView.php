...
if($rowCount==0){
    echo "<script>alert('Add a vehicle to continue!')</script>";
...
<html lang="en">
    ...
    <body>
        ...
        <div id="addStation">
            ...
            $db = mysqli_connect("localhost","root","","db_evplug");
            $loginId=$_SESSION['id'];
            $query = "SELECT * from tbl_userVehicle where loginId='$loginId'";
          ...
          <div class="container">
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-8"><h2><b>Vehicle Details</b></h2></div>
                            <div class="col-sm-4">
                                <a href="userVehicleAdd.php" ><i class="fa fa-plus" style="margin-top: 25px;"></i>Add New</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <tbody>
                          <?php
                            ...
                            <tr>
                                ...
                                <?php
                                $bid = $row['vehicleBrand'];
                                $query1 = "SELECT brandName from tbl_vehiclebrand where brandId='$bid'";
                                ...
                                <?php
                                $mid = $row['vehicleModel'];
                                $query2 = "SELECT modelName from tbl_vehiclemodel where modelId='$mid'";
