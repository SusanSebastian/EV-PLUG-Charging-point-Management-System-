                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="section-header text-left">
                            <p>Book your slot!</p>
                            <h2>Vehicle Charging detailing</h2>
                        </div>
                        <div class="about-content">
                            ...
                            $query1 = "SELECT * from tbl_station where status=1 and place='$s'";
                            ...
                            <form method="POST" name="booking">
                                <center>
                                    <div class="table-title">
                                        <div class="row">
                                            <div class="col-sm-8"><h2><b>Location Details</b></h2></div>
                                        </div>
                                    </div>
                                    <?php
                                    ...
                                    <table class="table" style="width: 1150px"> 
                                        ...
                                        <tbody>
                                            <?php while($row = mysqli_fetch_array($result1)){  
                                                ...
                                                $_SESSION['sid']=$stationid;
                                                $serviceQuery = "SELECT * FROM tbl_mapping where stationId='$stationid'";
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['noOfports']; ?></td>
                                                <td><?php echo $sid; ?></td>
                                                <td>
                                                    <button style="width:80px" class="btn btn-danger">
                                                      <a style="color:white" href="charging_type.php" onclick="return checkDelete()">Book</a></button>
                                                </td>
                                           </tr>
                                           <?php } ?>
                                        </tbody>
